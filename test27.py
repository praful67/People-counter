...
def nothing(x):
    pass
#video capture
var=cv.VideoCapture('sample-04.mp4')
# var=cv.VideoCapture('http://172.16.220.95:8080/video')
# var = get_footage()
...
#contours and tracking    
    contours, hierarchy = cv.findContours(th3.copy(), cv.RETR_EXTERNAL, cv.CHAIN_APPROX_SIMPLE)

    cv.drawContours(th3, contours, -1, (200,50,50), 2)
